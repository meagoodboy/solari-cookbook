# Crux report: home-assistant-hashseed-solari-seed7

Scenario home-assistant-hashseed-solari, seed 7, alpha 0.05.
...
Run `crux verify /Users/aswin/Project/crux/proof/realworld-solari` to rerun the investigation from its saved seed and check that the same cause comes back. Run `crux serve --directory /Users/aswin/Project/crux/proof/realworld-solari` to open the dashboard.
